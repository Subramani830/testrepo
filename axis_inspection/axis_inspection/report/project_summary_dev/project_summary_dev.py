...
def get_chart_data(data):
	...
	return {
		...
		"type": "bar",
		"colors": ["#fc4f51", "#ffd343","#00FF00", "#7575ff"],
		"barOptions": {
			"stacked": False
		}
	}
