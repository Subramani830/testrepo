	...
	[
		"name","in",
 			[
				...
				"Delivery Note Item-net_rate-permlevel",
				"Delivery Note Item-net_amount-permlevel",
				"Delivery Note Item-base_net_rate-permlevel",
				"Delivery Note Item-billed_amt-permlevel",
				"Delivery Note-base_total-permlevel",
				"Delivery Note-base_net_total-permlevel",
				"Delivery Note-total-permlevel",
				"Delivery Note-net_total-permlevel",
				"Delivery Note-base_grand_total-permlevel",
				"Delivery Note-base_rounding_adjustment-permlevel",
				"Delivery Note-base_rounded_total-permlevel",
				"Delivery Note-base_in_words-permlevel",
...
doc_events = {
	...
	"Salary Slip":{
		"before_insert":["axis_inspection.axis_inspection.doctype.salary_slip.salary_slip.additional_salary"],
